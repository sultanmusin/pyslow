...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy7.setHeightForWidth(self.moduleGrid.sizePolicy().hasHeightForWidth())
        self.moduleGrid.setSizePolicy(sizePolicy7)
        ...
        sizePolicy9.setHeightForWidth(self.busGrid.sizePolicy().hasHeightForWidth())
        self.busGrid.setSizePolicy(sizePolicy9)
        ...
        sizePolicy10.setHeightForWidth(self.checkBoxTemperatureControl.sizePolicy().hasHeightForWidth())
        self.checkBoxTemperatureControl.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.spinBoxCorrectionInterval.sizePolicy().hasHeightForWidth())
        self.spinBoxCorrectionInterval.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.checkBoxPoll.sizePolicy().hasHeightForWidth())
        self.checkBoxPoll.setSizePolicy(sizePolicy10)
        ...
        sizePolicy11.setHeightForWidth(self.groupBoxControl.sizePolicy().hasHeightForWidth())
        self.groupBoxControl.setSizePolicy(sizePolicy11)
        ...
        sizePolicy12.setVerticalStretch(250)
        sizePolicy12.setHeightForWidth(self.groupBoxHV.sizePolicy().hasHeightForWidth())
        self.groupBoxHV.setSizePolicy(sizePolicy12)
        ...
        sizePolicy13.setHeightForWidth(self.tableHV.sizePolicy().hasHeightForWidth())
        self.tableHV.setSizePolicy(sizePolicy13)
        self.tableHV.setMinimumSize(QSize(450, 440))
        ...
        sizePolicy14 = QSizePolicy(QSizePolicy.MinimumExpanding, QSizePolicy.MinimumExpanding)
        sizePolicy14.setHorizontalStretch(1)
        sizePolicy14.setVerticalStretch(80)
        sizePolicy14.setHeightForWidth(self.groupBoxLED.sizePolicy().hasHeightForWidth())
        self.groupBoxLED.setSizePolicy(sizePolicy14)
